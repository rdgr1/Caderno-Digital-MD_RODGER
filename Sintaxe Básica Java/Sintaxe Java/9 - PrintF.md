No Java, o método equivalente ao `printf` (usado em C) é o `System.out.printf()`, que permite formatar a saída. Para os tipos primitivos, você pode usar especificadores de formato com `%`, semelhantes aos usados em C.
